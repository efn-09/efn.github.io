...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Kakaaa >_<", "Aku ada pertanyaan nih buat kamu bebby", "question").then(function () {
      ...
      Swal.fire("Awas aja kalau kamu bohong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} Sayang ga sama nafis?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`Aku juga sayang banget sama kamu ${nama}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih ya udah sayang sama akuu sebesar ${val}%`).then(function () {
                    Swal.fire({
